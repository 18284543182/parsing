...
import com.zklt.parsing.model.entity.SpaceWeatherMonitoringDscovrPlasma;
 ...
 */
@Service
@Mapper(type = "SpaceWeatherMonitoringDscovrPlasma", getAction = SpaceWeatherMonitoringDscovrPlasma.class)
public class SpaceWeatherMonitoringDscovrPlasmaAction implements MessageAction<SpaceWeatherMonitoringDscovrPlasma> {
    @Override
    public Object doAction(HandlerMessage<SpaceWeatherMonitoringDscovrPlasma> message) {
