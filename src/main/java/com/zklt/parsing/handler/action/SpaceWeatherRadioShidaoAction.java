 ...
 */
@Service
@Mapper(type = "SpaceWeatherRadioShidao", getAction = SpaceWeatherRadioShidao.class)
public class SpaceWeatherRadioShidaoAction implements MessageAction<SpaceWeatherRadioShidao> {
    @Override
    public Object doAction(HandlerMessage<SpaceWeatherRadioShidao> message) {
