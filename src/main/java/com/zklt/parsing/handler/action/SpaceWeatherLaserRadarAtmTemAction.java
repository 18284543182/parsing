 ...
 */
@Service
@Mapper(type = "SpaceWeatherLaserRadarAtmTem", getAction = SpaceWeatherLaserRadarAtmTem.class)
public class SpaceWeatherLaserRadarAtmTemAction implements MessageAction<SpaceWeatherLaserRadarAtmTem> {
    @Override
    public Object doAction(HandlerMessage<SpaceWeatherLaserRadarAtmTem> message) {
