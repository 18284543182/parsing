 ...
 */
@Service
@Mapper(type = "SpaceWeatherRegionNowNcasts4", getAction = SpaceWeatherRegionNowNcasts4.class)
public class SpaceWeatherRegionNowNcasts4Action implements MessageAction<SpaceWeatherRegionNowNcasts4> {
    @Override
    public Object doAction(HandlerMessage<SpaceWeatherRegionNowNcasts4> message) {
