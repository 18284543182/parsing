 ...
 */
@Service
@Mapper(type = "SpaceweatherIonoSoude", getAction = SpaceWeatherS4Uhfband.class)
public class SpaceweatherIonoSoudeAction implements MessageAction<SpaceWeatherS4Uhfband> {
    @Override
