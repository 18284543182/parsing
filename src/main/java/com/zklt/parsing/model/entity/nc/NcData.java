...
public class NcData {
    ...
    private int[] data1Di;      //int类型的一维数组
    private int[][] data2Di;      //int类型的二维数组
    private int[][][] data3Di;      //int类型的三维数组
    ...
    public void setData1Di(int[] data1Di){
        this.data1Di=data1Di;
    }

    public void setData2Di(int[][] data2Di){
        this.data2Di=data2Di;
    }
    public void setData3Di(int[][][] data3Di){
        this.data3Di=data3Di;
    }

    public int[] getData1Di(){
        return data1Di;
    }
    public int[][] getData2Di(){
        return data2Di;
    }
    public int[][][] getData3Di(){
        return data3Di;
    }
}